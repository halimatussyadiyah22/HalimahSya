...
public class exercise32_chanceOfWinningAtCraps {
    public static void main(String[] args) {
        ...
        System.out.println(" nomer yang memenangkan game : " + count);
    }
    ...
    public static void printScore(int dice1 , int dice2){
        System.out.println(" kamu memutar " + dice1 + " + " + dice2 + " = " + (dice1+dice2));
    }
}
