...
public class Listing4_BMI {
    ...
    public Listing4_BMI(String name, int age, double weight, double height){
        this.name = name;
        this.age = age;
        this.weight = weight;
        this.height = height;
    }
    public Listing4_BMI(String name,double weight,double height){
